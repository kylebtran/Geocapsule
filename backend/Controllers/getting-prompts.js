...
const model = genAI.getGenerativeModel({ model: "gemini-pro", system_instruction:"Start each prompt with a verb, and return fun & safe prompts. Never use the word \"let's\" and don't use emojis. Be lighthearted."});
